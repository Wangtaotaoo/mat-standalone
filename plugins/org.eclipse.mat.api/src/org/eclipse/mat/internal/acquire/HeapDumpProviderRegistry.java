...
public class HeapDumpProviderRegistry extends RegistryReader<IHeapDumpProvider>
{
                    ...
                    throws SnapshotException
    {
        ...
        if (providersByIdentifier.containsKey(identifier))
            throw new SnapshotException(MessageUtil.format(Messages.HeapDumpProviderRegistry_NameAlreadyBouneErrorMsg,
                            identifier, providersByIdentifier.get(identifier).getSubject().getName()));
        ...
        HeapDumpProviderDescriptor descriptor = new HeapDumpProviderDescriptor(identifier, name, usage, help, helpUrl,
                        helpLoc, provider);
    ...
    private void addArguments(IHeapDumpProvider provider, Class<?> clazz, HeapDumpProviderDescriptor descriptor,
        ...
        for (Field field : fields)
        {
            ...
            catch (Exception e)
            {
                throw new SnapshotException(MessageUtil.format(
                                Messages.HeapDumpProviderRegistry_ErrorGettingArgumentErrorMsg, field.getName(),
                                clazz.getName()), e);
            }
        }
    }
                    ...
                    throws SnapshotException
    {
        ...
        {
            String msg = MessageUtil.format(Messages.HeapDumpProviderRegistry_WrongTypeErrorMsg, field.getName(),
