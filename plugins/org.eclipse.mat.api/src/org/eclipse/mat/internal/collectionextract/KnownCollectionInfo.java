...
public class KnownCollectionInfo implements ICollectionExtractorProvider
{
    ...
    private static CollectionExtractionInfo[] knownCollections = new CollectionExtractionInfo[] {
                    ...
                    new CollectionExtractionInfo("java.lang.ProcessEnvironment$StringEnvironment", new WrapperFieldMapExtractor("m", "str", "str")), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
                    new CollectionExtractionInfo("java.lang.ProcessEnvironment$StringEntrySet", new WrapperMapExtractor("s")), //$NON-NLS-1$ //$NON-NLS-2$
                    new CollectionExtractionInfo("java.lang.ProcessEnvironment$StringKeySet", new WrapperFieldMapExtractor("s", "str", "str")), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
                    new CollectionExtractionInfo("java.lang.ProcessEnvironment$StringValues", new WrapperFieldCollectionExtractor("s", "str")), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
