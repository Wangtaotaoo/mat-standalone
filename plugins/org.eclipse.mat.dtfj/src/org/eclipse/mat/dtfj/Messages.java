...
public class Messages extends NLS
{
    ...
    public static String DTFJIndexBuilder_DTFJJavaRuntime_File;
    public static String DTFJIndexBuilder_DTFJJavaRuntime_ImplementationUnmatched;
    ...
    public static String InitDTFJ_ErrorUpdatingBundle;
