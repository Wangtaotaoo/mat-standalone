...
{
    private static final URL SUM = TotalsRow.class.getClassLoader().getResource("META-INF/icons/misc/sum.gif"); //$NON-NLS-1$
    private static final URL SUM_PLUS = TotalsRow.class.getClassLoader().getResource("META-INF/icons/misc/sum_plus.gif"); //$NON-NLS-1$
