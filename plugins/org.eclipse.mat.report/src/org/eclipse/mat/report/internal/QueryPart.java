...
public class QueryPart extends AbstractPart
{
                    ...
                    throws SnapshotException, IOException
    {
        ...
        if (result == null)
        {
            if (getCommand() == null)
            {
                ReportPlugin.log(2, MessageUtil.format(Messages.QueryPart_Error_NoCommand, //
        ...
        else if (result instanceof IResultPie && false) //$NON-NLS-1$
        {
    ...
    private void addDerivedDataColumns(IQueryContext context, RefinedResultBuilder builder, IResult result)
    {
        ...
        for (String provider : providers)
        {
            ...
            if (p < 0)
            {
                ReportPlugin.log(1, MessageUtil.format(Messages.QueryPart_Error_InvalidProvider,
            ...
            if (operation == null)
            {
                ReportPlugin.log(1, MessageUtil.format(Messages.QueryPart_Error_InvalidProviderOperation,
