        ...
        private void deleteDirectory(File dir)
        {
            ...
            if (fileArray != null)
            {
                for (int i = 0; i < fileArray.length; i++)
                {
                    ...
                    {
                        ReportPlugin.log(1, MessageUtil.format(Messages.FileUtils_FileUtils_FailedToDeleteFile, fileArray[i].getAbsolutePath()));
                    }
            ...
            if (!dir.delete())
            {
                ReportPlugin.log(1, MessageUtil.format(Messages.FileUtils_FailedToDeleteDirectory, dir.getAbsolutePath()));
            }
        }
    }
