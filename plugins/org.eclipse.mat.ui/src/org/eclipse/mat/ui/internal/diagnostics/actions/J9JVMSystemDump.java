 ...
 */
public class J9JVMSystemDump extends J9JVMBase
{
    @Override
    public void run(DiagnosticsProgress progress)
    {
        try
        {
            String fileName = (String) triggerDump.invoke(null, new Object[] { "system:request=exclusive+prepwalk" }); //$NON-NLS-1$
            progress.appendText(MessageUtil.format(Messages.DiagnosticsAction_Dump_Completed, fileName));
        }
